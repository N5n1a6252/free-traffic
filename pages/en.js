...
const En = () => {
    ...
    <div className='flex gap-3 px-3'>
        <div className="relative w-32 text-center justify-center align-middle items-center">
            <div className="absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 w-5/6 md:w-4/6">
                <img src='https://play-lh.googleusercontent.com/HSpN1UFhKAa5R_4ILrEKyIrR0pTvSSZyfkjozzljlw9QlKcyP0s6tpMNcXjkwZkWxdU' className="image" width='100px' height='100px' /> {/* I M A G E   H E R E */}
            </div>
        </div>
        <div>
            <h6 className='text-gray-300 text-sm'>Author: <span className="text-red-300">gg-ez.net</span></h6>
            <h1 className="font-bold text-gray-600 text-2xl">SOSO++</h1> {/* T I T L E   H E R E */}
            ...
            <div className='flex'>
                ...
                <div onClick={e => choose_niche(e)} className={`${search !== '' && !'facebook face book facebook facebok'.includes(search) && 'hidden'} w-full bg-gray-50 rounded-xl shadow-lg mt-4 md:my-2 relative py-8 cursor-pointer `}>
    ...
    <div className='flex gap-3 px-3'>
        <div className="relative w-32 text-center justify-center align-middle items-center">
            <div className="absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 w-5/6 md:w-4/6">
                <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Facebook_Logo_%282019%29.png/1024px-Facebook_Logo_%282019%29.png' className="image" width='100px' height='100px' /> {/* I M A G E   H E R E */}
            </div>
        </div>
        <div>
            <h6 className='text-gray-300 text-sm'>Author: <span className="text-red-300">gg.net</span></h6>
            <h1 className="font-bold text-gray-600 text-2xl">Facebook</h1> {/* T I T L E   H E R E */}
            <p className="text-gray-400 text-sm description">This app will help you get a verification badge for facebook.</p> {/* D E S C R I P T I O N   H E R E */}
            <div className='flex'>
                <StarIcon className='mt-2 text-yellow-400'/>
                <StarIcon className='mt-2 text-yellow-400'/>
                <StarIcon className='mt-2 text-yellow-400'/>
